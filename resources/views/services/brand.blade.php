            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <h1 class="fw-bolder heading-1 text-center mb-3"><span
                            class="text-warning">Brand identity design</span> for your business</h1>
                    <p class="body-text text-center mb-2">Logo and stationary designs for your startup or business</p>
                    <a href="{{ route('contact') }}">
                        <div type="button" class="btn-cta btn-ic btn-big w-100">Request a brand</div>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="row">
                    @forelse($brands as $brand)
                        <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                            <a href="{{ route('details',$brand->slug) }}" class="nav-link">
                                <div class="card card-background move-on-hover mb-3">
                                    <div class="full-background"
                                         style="background-image: url('{{ asset(Voyager::image($brand->image)) }}')"></div>
                    ...
                    @empty
                        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 ">
                            <div class="card card-background move-on-hover mb-3">
                                ...
                                <div class="card-body pt-12">
                                    <h4 class="text-white h2">No Yet Brand Posted</h4>
                                </div>
                            </div>
                        </div>
